...
export const story: StoryStep[] = [
  ...
  },
  {
    id: 'our-father',
    type: 'code',
    text: 'Продолжи молитву: «Да святится имя Твоё; да приидет…»',
    placeholder: 'Введи слово...',
    acceptedAnswers: ['царствие твое', 'царствие твоё', 'царствие', 'царство твое', 'царство твоё'],
    incorrectMessage: 'Не совсем.',
    submitLabel: 'Проверить',
  },
  {
    id: 'first-woman',
    type: 'code',
    text: 'Как звали первую женщину, согласно Библии?',
    placeholder: 'Введи имя...',
    acceptedAnswers: ['ева'],
    incorrectMessage: 'Не совсем.',
    submitLabel: 'Проверить',
  },
  {
    id: 'riddle-lock',
    type: 'code',
    text: 'Не лает, не кусает, а в дом не пускает. Что это?',
    placeholder: 'Введи слово...',
    acceptedAnswers: ['замок'],
    incorrectMessage: 'Не совсем.',
    submitLabel: 'Проверить',
  },
  {
    id: 'riddle-onion',
    type: 'code',
    text: 'Сидит дед, во сто шуб одет. Кто его раздевает, тот слёзы проливает. Что это?',
    placeholder: 'Введи слово...',
    acceptedAnswers: ['лук'],
    incorrectMessage: 'Не совсем.',
    submitLabel: 'Проверить',
  ...
  },
  {
    id: 'riddle-oranges',
    type: 'code',
    text: 'Два отца и два сына разделили три апельсина так, что каждому досталось ровно по одному целому апельсину, и никто ничего не делил. Сколько всего человек это было?',
    placeholder: 'Введи число...',
    acceptedAnswers: ['3', 'три', 'трое'],
    incorrectMessage: 'Не совсем.',
    hint: 'Один человек может быть одновременно и отцом, и сыном.',
    submitLabel: 'Проверить',
  },
  {
    id: 'riddle-short-month',
    type: 'code',
    text: 'Какой месяц в году самый короткий?',
    placeholder: 'Введи слово...',
    acceptedAnswers: ['май'],
    incorrectMessage: 'Не совсем.',
    hint: 'Считай буквы, а не дни.',
    submitLabel: 'Проверить',
  },
  {
    id: 'call-task',
    type: 'task',
    eyebrow: 'НЕ ВСЕ ОТВЕТЫ ЕСТЬ НА ЭТОМ ЭКРАНЕ',
    text: 'Для этого точно придётся встать — точнее, взять телефон.',
    instruction: 'Позвони мне. Я продиктую код.',
    continueLabel: 'Я позвонила и получила код',
  },
  {
    id: 'call-code',
    type: 'code',
    text: 'Какой код я тебе продиктовал?',
    placeholder: 'Введи код...',
    acceptedAnswers: ['9108'],
    incorrectMessage: 'Не совсем.',
    submitLabel: 'Проверить',
    continuesProgress: true,
  },
